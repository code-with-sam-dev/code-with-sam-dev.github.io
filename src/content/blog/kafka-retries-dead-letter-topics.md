...
draft: false
terminal:
  path: 'kafka-payments / episode-06-retries'
  lines:
    - '$ kafka-console-consumer --topic payments.DLT'
    - ''
    - '  attempts=5  outcome=still failing'
    - ''
    - '  Nothing is broken. Nothing is going to change.'
---
